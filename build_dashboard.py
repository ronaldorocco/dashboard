...
.chat-ia-inputbar{{display:flex;gap:8px;padding:12px;border-top:1px solid #EEE;flex-shrink:0;}}
.chat-ia-inputbar input{{flex:1;border:1px solid #DDD;border-radius:6px;padding:8px 10px;font-size:12px;font-family:inherit;min-width:0;}}
...
<div id="chat-ia-panel" class="chat-ia-panel">
  ...
  <div class="chat-ia-inputbar">
    ...
    <input id="chat-ia-input" type="text" placeholder="Digite sua pergunta..."
