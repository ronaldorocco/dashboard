...
.chat-ia-inputbar textarea{{flex:1;border:1px solid #DDD;border-radius:6px;padding:8px 10px;font-size:12px;
  font-family:inherit;min-width:0;resize:vertical;min-height:34px;max-height:140px;line-height:1.4;}}
...
<div id="chat-ia-panel" class="chat-ia-panel">
  ...
  <div class="chat-ia-inputbar">
    ...
    <textarea id="chat-ia-input" rows="1" placeholder="Digite ou cole sua pergunta... (Enter envia, Shift+Enter quebra linha)"
