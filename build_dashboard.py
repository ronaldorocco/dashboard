...
@media(max-width:768px){{
  ...
  /* Header */
  .header-row1{{padding:7px 10px;gap:6px;}}
  .header-row2{{padding:4px 10px 5px;gap:4px;flex-wrap:nowrap;overflow-x:auto;}}
  .header h1{{font-size:12px;white-space:normal;}}
  .pesquisa-header input{{width:130px;}}
  .header-row2 button{{padding:5px 4px;font-size:10px;flex-shrink:0;}}
  .badge{{display:none;}}
